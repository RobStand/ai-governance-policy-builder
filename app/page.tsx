    ...
    <main className="min-h-screen">
      <div className="mx-auto max-w-5xl px-6 py-20 sm:py-28">
        ...
        <div className="mt-9 flex flex-wrap items-center gap-4">
          <Link
            href="/configure"
            className="inline-flex items-center rounded-md bg-accent px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-accent-dark"
          >
        ...
        <div className="mt-16 rounded-lg border border-line bg-white p-6">
          <div className="font-mono text-xs uppercase tracking-wide text-muted">
            Nine policy sections
          </div>
          <ol className="mt-4 grid gap-x-8 gap-y-2 text-sm text-ink sm:grid-cols-2 lg:grid-cols-3">
            {SECTIONS.map((s, i) => (
